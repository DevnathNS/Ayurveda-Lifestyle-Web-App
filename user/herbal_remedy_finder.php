...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['dosha'])) {
    $dosha = $_POST['dosha'];
    if ($dosha === 'vata') {
        header("Location: vata_remedies.php");
        exit;
    } elseif ($dosha === 'pitta') {
        header("Location: pitta_remedies.php");
        exit;
    } elseif ($dosha === 'kapha') {
        header("Location: kapha_remedies.php");
        exit;
    }
}
?>
...
<head>
    ...
    <title>Herbal Remedy Finder</title>
